/**
 * @file  cloud_mux_integer.cpp
 * @brief TFHEの整数型の条件演算子のテスト.
 **/
#include <cassert>
...
int main() {
  ...
  TFHEBool bool1 = integer1 > integer2;
  printf("integer1 > integer2 ? integer1 : integer2\n");
  start_timer();
  TFHEInteger<8> integer3 = mux(bool1, integer1, integer2);
